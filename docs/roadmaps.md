...
| Roadmap | Priority | Description |
|---------|----------|-------------|
| [Branding & UI Consistency](plans/branding-ui-consistency-roadmap.md) | HIGH | Header refactor, logo/app icon, theme customization |
...
|---------|----------|--------------|
| [Notifications](plans/notifications-roadmap.md) | HIGH | None (Settings Restructure complete) |
| [Versioning System](plans/versioning-system-roadmap.md) | MEDIUM | None (Settings Restructure complete) |
